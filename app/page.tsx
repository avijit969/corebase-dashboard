      ...
      <main className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/platform">
                <Button size="lg" className="h-14 px-8 text-lg bg-linear-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 border-0 shadow-lg shadow-primary-500/25 text-white cursor-pointer rounded-full transition-all hover:scale-105 active:scale-95">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-32">
          ...
          <div className="flex-1 w-full max-w-lg">
            <Card className="bg-[#0D0D0D] border-white/10 overflow-hidden shadow-2xl shadow-primary-900/10">
        ...
        {/* CTA Section */}
        <div className="relative rounded-3xl bg-linear-to-b from-primary-900/20 to-neutral-900 border border-primary-500/20 p-12 text-center overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary-500/10 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 relative z-10">
            Ready to <span className="text-primary-500">Scale</span>?
          </h2>
          ...
          <div className="flex justify-center relative z-10">
            <Link href="/platform/signup">
              <Button size="lg" className="h-14 px-10 text-lg bg-white text-black hover:bg-primary-50 border-0 shadow-xl shadow-primary-900/20 rounded-full transition-all hover:scale-105">
                Create Free Account
              </Button>
            </Link>
          </div>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  ...
  return (
    <motion.div variants={itemVariants} whileHover={{ y: -8, transition: { duration: 0.3 } }}>
      <Card className="bg-neutral-900/40 border-white/5 backdrop-blur-sm text-white h-full hover:bg-primary-950/20 hover:border-primary-500/20 transition-all duration-300 group overflow-hidden relative">
